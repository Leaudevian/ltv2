...
AddEventHandler('playerJoining', function()
    ...
    TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^2* ' .. GetPlayerName(source) .. ' a rejoint la ville.')
end)
...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerClientEvent('chatMessage', -1, '', { 255, 255, 255 }, '^2* ' .. GetPlayerName(source) ..' a quitté la ville (' .. reason .. ')')
end)
