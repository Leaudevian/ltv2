...
RegisterNetEvent('qb-admin:client:toggleBlips', function()
    if not ShowBlips then
        ShowBlips = true
        QBCore.Functions.Notify("Blips activés !", "success")
    else
        ShowBlips = false
        QBCore.Functions.Notify("Blips désactivés !", "error")
    end
end)
...
RegisterNetEvent('qb-admin:client:toggleNames', function()
    if not ShowNames then
        ShowNames = true
        QBCore.Functions.Notify("Noms des joueurs visibles !", "success")
    else
        ShowNames = false
        QBCore.Functions.Notify("Noms des joueurs désactivés !", "error")
    end
end)
