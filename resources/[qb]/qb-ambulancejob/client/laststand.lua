        ...
        Citizen.CreateThread(function()
            while InLaststand do
                ...
                elseif LaststandTime - 1 <= 0 then
                    QBCore.Functions.Notify("Tu as saigné..", "error")
                    SetLaststand(false)
...
AddEventHandler('hospital:client:HelpPerson', function(targetId)
    ...
    QBCore.Functions.Progressbar("hospital_revive", "Réanimation de la personne..", math.random(30000, 60000), false, true, {
        ...
        ClearPedTasks(ped)
        QBCore.Functions.Notify("Vous avez réanimé la personne.")
