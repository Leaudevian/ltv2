...
Config.Locations = {
    ...
    ["duty"] = {
        [1] = vector4(311.7, -594.05, 43.29, 0.0),
        [2] = vector4(-254.88, 6324.5, 32.58, 0.0),
    },
    ["outfit"] = {
        [1] = vector4(299.08, -598.21, 43.28, 0.0),
        [2] = vector4(-250.88, 6324.5, 32.58, 0.0),
    }, 
    ["vehicle"] = {
    ...
    ["armory"] = {
        [1] = vector4(306.36, -601.47, 43.28, 90.654),
        [2] = vector4(-245.13, 6315.71, 32.82, 90.654),
    },
    ["roof"] = {
        [1] = vector4(339.85, -584.07, 74.16, 249.19),
    },
    ["main"] = {
        [1] = vector4(331.58, -595.5, 43.28, 252.76),
    },        
    ["beds"] = {
        [1] = {coords = vector4(319.3, -580.93, 44.2, 155.81), taken = false, model = 1631638868},
        [2] = {coords = vector4(324.09, -582.97, 44.2, 154.44), taken = false, model = 1631638868},
        [3] = {coords = vector4(313.99, -579.07, 44.2, 140.61), taken = false, model = 1631638868},
        [4] = {coords = vector4(309.51, -577.3, 44.2, 149.93), taken = false, model = 1631638868},
        [5] = {coords = vector4(317.54, -585.49, 44.2, 332.34), taken = false, model = 1631638868},
        [6] = {coords = vector4(314.37, -584.15, 44.2, 327.19), taken = false, model = 1631638868},
        [7] = {coords = vector4(310.95, -583.06, 44.2, 333.96), taken = false, model = 1631638868},
        [8] = {coords = vector4(322.59, -586.99, 44.2, 325.42), taken = false, model = 1631638868},
        [9] = {coords = vector4(307.89, -581.89, 44.23, 331.97), taken = false, model = 1631638868},
    }, 
    ["stations"] = {
        [1] = {label = "Docteur Post Paleto", coords = vector4(-254.88, 6324.5, 32.58, 3.5)},
        [2] = {label = "Hôpital Pillbox", coords = vector4(304.27, -600.33, 43.28, 272.249)}
    }
}
...
Config.BleedingStates = {
    [1] = {label = 'Faible saignement ..', damage = 10, chance = 50},
    [2] = {label = 'Saignement ..', damage = 15, chance = 65},
    [3] = {label = 'Saignement important ..', damage = 20, chance = 65},
    [4] = {label = 'Saignement très important..', damage = 25, chance = 75},
}
