...
AddEventHandler('qb-anticheat:server:banPlayer', function(reason)
    local src = source
    TriggerEvent("qb-log:server:CreateLog", "anticheat", "Anti-Cheat", "white", GetPlayerName(src).."a été banni pour "..reason, false)
    ...
    DropPlayer(src, "Vous avez été banni pour triche. Consultez notre Discord pour plus d'informations: " .. QBCore.Config.Server.discord)
end)
