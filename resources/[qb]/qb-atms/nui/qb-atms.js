        ...
        if ($('#pinContainer').is(':visible')) {
            if (key.which >= 48 && key.which <= 57) { // 48 - 57 (0-9 keys)
                ...
                if (currentVal == clientPin) {
                    ...
                    $('#errorMsg').html('Veuillez entrer votre code PIN de votre carte de crédit, pour accéder au guichet automatique.');
                    $('#pinCode').val('');
                    ...
                    $('#errorMsg').html('Vous avez entré un code PIN incorrect, veuillez réessayer.')
                    setTimeout(function () {
                        $('#errorMsg').addClass('alert-info').removeClass('alert-danger');
                        $('#errorMsg').html('Veuillez entrer votre code PIN de votre carte de crédit, pour accéder au guichet automatique.');
                    }, 5000);
