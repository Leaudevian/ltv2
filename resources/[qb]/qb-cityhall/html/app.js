...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $(".identity-page-blocks").html('<div class="identity-page-block" data-type="id_card"><p>Carte d\'identité</p></div>');
...
$(document).on("click", ".identity-page-block", function(e){
    ...
    if (selectedIdentity == null) {
        ...
        if (idType == "id_card") {
            ...
            $(".request-identity-button").html("<p>Acheter 50$</p>")
        ...
        selectedIdentity = this;
        if (idType == "id_card") {
            $(".request-identity-button").html("<p>Acheté</p>")
        } else if (idType == "driver_license") {
            $(".request-identity-button").html("<p>Acheté</p>")
        } else if (idType == "weaponlicense") {
            $(".request-identity-button").html("<p>Acheté</p>")
