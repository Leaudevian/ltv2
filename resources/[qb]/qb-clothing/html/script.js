...
QBClothing.ReloadOutfits = function(outfits) {
    ...
    $.each(outfits, function(index, outfit){
        var elem = '<div class="clothing-menu-option" data-myOutfit="'+(index + 1)+'"> <div class="clothing-menu-option-header"><p>'+outfit.outfitname+'</p></div><div class="clothing-menu-myOutfit-option-button"><p>Selectrionner</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p>Supprimer</p></div></div>'
    ...
    $.each(data.menus, function(i, menu){
        ...
        if (menu.menu == "roomOutfits") {
            $.each(menu.outfits, function(index, outfit){
                var elem = '<div class="clothing-menu-option" data-outfit="'+(index + 1)+'"> <div class="clothing-menu-option-header"><p>'+outfit.outfitLabel+'</p></div> <div class="clothing-menu-outfit-option-button"><p>Sélectionnez la tenue</p></div> </div>'
        ...
        if (menu.menu == "myOutfits") {
            $.each(menu.outfits, function(index, outfit){
                var elem = '<div class="clothing-menu-option" data-myOutfit="'+(index + 1)+'"> <div class="clothing-menu-option-header"><p>'+outfit.outfitname+'</p></div><div class="clothing-menu-myOutfit-option-button"><p>Sélectrionner</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p>Supprimer</p></div></div>'
                $(".clothing-menu-myOutfits-container").append(elem)
