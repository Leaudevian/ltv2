    ...
    $.post(
        ...
        function(data) {
            ...
            $(".weapon-attachments-container-details").html(
                '<span style="font-weight: bold; letter-spacing: .1vh;">Numéro de série</span><br> ' +
                ClickedItemData.info.serie +
                '<br><br><span style="font-weight: bold; letter-spacing: .1vh;">Durabilité - ' +
                Durability.toFixed() +
            ...
            if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
                if (data.AttachmentData.length > 0) {
                    $(".weapon-attachments-title").html(
                        '<span style="font-weight: bold; letter-spacing: .1vh;">Accessoires</span>'
                    );
                    ...
                    $(".weapon-attachments-title").html(
                        '<span style="font-weight: bold; letter-spacing: .1vh;">Cette arme n\'a pas d\'accessoires</span>'
                    );
                }
            } else {
                $(".weapon-attachments-title").html(
...
$(document).on("click", "#weapon-attachments", function(e) {
    ...
    if (!Inventory.IsWeaponBlocked(ClickedItemData.name)) {
        ...
        $.post(
            ...
            JSON.stringify({
                message: "Aucun accessoire disponible pour cette arme.",
                type: "error",
            })
        );
    }
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Nom de famille: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Date de naissance: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Sexe: </strong><span>" +
                gender +
                "</span></p><p><strong>Nationalité: </strong><span>" +
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Date de naissance: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Licences: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html(
                    "<p><strong>Numéro de série: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Munition: </strong><span>" +
                    itemData.info.ammo +
                    "</span></p><p><strong>Accessoires: </strong><span>" +
                    attachmentString +
                    "</span></p>"
                );
            } else {
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    "<p><strong>Preuve matériel: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Numéro de type: </strong><span>" +
                    itemData.info.ammotype +
                    "</span></p><p><strong>Calibre: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Numéro de série: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Scène de crime: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Preuve matériel: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Groupe sanguin: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Preuve matériel: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Empreinte digitale: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Argent liquide: </strong><span>$" +
                itemData.info.cash +
                "</span></p>"
            );
                    ...
                    $.post(
                        ...
                        function(item) {
                            $(".combine-option-text").html(
                                "<p>Si vous combinez ces objets, vous obtenez: <b>" +
                                item.label +
                                "</b></p>"
                            );
                        }
    ...
    window.onload = function(e) {
        window.addEventListener("message", function(event) {
            switch (event.data.action) {
                ...
                case "RobMoney":
                    $(".inv-options-list").append(
                        '<div class="inv-option-item" id="rob-money"><p>PREND L\'ARGENT</p></div>'
                    );
