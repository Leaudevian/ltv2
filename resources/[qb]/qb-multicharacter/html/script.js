    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                var originalText = "Récupérer les données du joueur";
                ...
                var DotsInterval = setInterval(function () {
                    ...
                    if (loadingProgress == 3) {
                        originalText = "Validation des données du joueur"
                        $("#loading-text").html(originalText);
                    }
                    ...
                    if (loadingProgress == 6) {
                        originalText = "Validation des personnages"
                        $("#loading-text").html(originalText);
                    }
                    if (loadingDots == 4) {
                        $("#loading-text").html(originalText);
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        $('.character-info-valid').html('<span id="no-char">L\'emplacement sélectionné n\'est pas encore utilisé.<br><br>Ce personnage n\'a pas encore d\'information.</span>');
    } else {
        var gender = "Homme"
        if (cData.charinfo.gender == 1) { gender = "Femme" }
        $('.character-info-valid').html(
            ...
            '<div class="character-info-box"><span id="info-label">Sexe: </span><span class="char-info-js">' + gender + '</span></div>' +
            ...
            '<div class="character-info-box"><span id="info-label">Travail: </span><span class="char-info-js">' + cData.job.label + '</span></div>' +
            '<div class="character-info-box"><span id="info-label">Espèces: </span><span class="char-info-js">' + cData.money.cash + ' &#36;</span></div>' +
            '<div class="character-info-box"><span id="info-label">Banque: </span><span class="char-info-js">' + cData.money.bank + ' &#36;</span></div>' +
            '<div class="character-info-box"><span id="info-label">Tel: </span><span class="char-info-js">' + cData.charinfo.phone + '</span></div>' +
            '<div class="character-info-box"><span id="info-label">Numéro de compte: </span><span class="char-info-js">' + cData.charinfo.account + '</span></div>');
    }
}
...
function refreshCharacters() {
    $('.characters-list').html('<div class="character" id="char-1" data-cid=""><span id="slot-name">Emplacement vide<span id="cid"></span></span></div><div class="character" id="char-2" data-cid=""><span id="slot-name">Emplacement vide<span id="cid"></span></span></div><div class="character" id="char-3" data-cid=""><span id="slot-name">Emplacement vide<span id="cid"></span></span></div><div class="character" id="char-4" data-cid=""><span id="slot-name">Emplacement vide<span id="cid"></span></span></div><div class="character" id="char-5" data-cid=""><span id="slot-name">Emplacement vide<span id="cid"></span></span></div><div class="character-btn" id="play"><p id="play-text">Sélectionnez un personnage</p></div><div class="character-btn" id="delete"><p id="delete-text">Sélectionnez un personnage</p></div>')
    setTimeout(function () {
        $(selectedChar).removeClass("char-selected");
        selectedChar = null;
        $.post('https://qb-multicharacter/setupCharacters');
