        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Cette personne est occupée!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Cette personne n'est pas disponible!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Vous ne pouvez pas vous appeler!");
        }
    });
});
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
        ...
        QB.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "Vous ne pouvez pas vous whatsapp vous-même..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Modifier le contact", "Remplir tous les champs!");
    }
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Ajouter un contact", "Remplir tous les champs!");
    }
});
