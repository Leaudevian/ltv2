...
AddEventHandler('police:client:sendBillingMail', function(amount)
    SetTimeout(math.random(2500, 4000), function()
        ...
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            ...
            subject = "Recouvrement judiciaire",
            message = "Cher " .. gender .. " " .. charinfo.lastname .. ",<br /><br />L'Agence centrale de recouvrement judiciaire (CJCA) a facturé les amendes que vous avez reçues de la police.<br />Il y a un retrait de <strong>"..amount.."$</strong> sur votre compte.<br /><br />Cordialement,<br />Mr. I.K. Graai",
            button = {}
        })
    end)
end)
