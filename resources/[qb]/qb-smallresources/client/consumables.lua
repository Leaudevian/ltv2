...
AddEventHandler("consumables:client:UseJoint", function()
    QBCore.Functions.Progressbar("smoke_joint", "Allumer le joint..", 1500, false, true, {
...
AddEventHandler("consumables:client:UseParachute", function()
    EquipParachuteAnim()
    QBCore.Functions.Progressbar("use_parachute", "Ouvrir le parachute..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler("consumables:client:ResetParachute", function()
    if ParachuteEquiped then 
        EquipParachuteAnim()
        QBCore.Functions.Progressbar("reset_parachute", "Ranger le parachute..", 40000, false, true, {
            disableMovement = false,
            disableCarMovement = false,
            disableMouse = false,
            disableCombat = true,
        ...
        QBCore.Functions.Notify("Tu n'as pas de parachute!", "error")
    end
end)
...
AddEventHandler("consumables:client:UseArmor", function()
    QBCore.Functions.Progressbar("use_armor", "Mettre son bouclier..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler("consumables:client:UseHeavyArmor", function()
    ...
    QBCore.Functions.Progressbar("use_heavyarmor", "Mettre son gilet par balle..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler("consumables:client:ResetArmor", function()
    ...
    if currentVest ~= nil and currentVestTexture ~= nil then 
        QBCore.Functions.Progressbar("remove_armor", "Retirer son gilet par balle..", 2500, false, true, {
            disableMovement = false,
            disableCarMovement = false,
            disableMouse = false,
            disableCombat = true,
        ...
        QBCore.Functions.Notify("Vous ne portez pas de gilet..", "error")
    end
end)
...
AddEventHandler("consumables:client:DrinkAlcohol", function(itemName)
    ...
    QBCore.Functions.Progressbar("snort_coke", "Boire de la liqueur..", math.random(3000, 6000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("consumables:client:Cokebaggy", function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_coke", "Se faire un petit rail de coke..", math.random(5000, 8000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("consumables:client:Crackbaggy", function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_coke", "Fumée du crack..", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler('consumables:client:EcstasyBaggy', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Prendre de l'ecstasy", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler("consumables:client:Eat", function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", "Manger..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
AddEventHandler("consumables:client:Drink", function(data)
    TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
    QBCore.Functions.Progressbar("drink_something", "Boire..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
