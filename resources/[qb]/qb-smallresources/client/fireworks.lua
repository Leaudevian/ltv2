...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if fireworkTime > 0 and fireworkLoc ~= nil then
            DrawText3Ds(fireworkLoc.x, fireworkLoc.y, fireworkLoc.z, "Feu d'artifice dans ~r~"..fireworkTime)
        end
    end
end)
...
AddEventHandler("fireworks:client:UseFirework", function(itemName, assetName)
    QBCore.Functions.Progressbar("spawn_object", "Placer l'objet..", 3000, false, true, {
