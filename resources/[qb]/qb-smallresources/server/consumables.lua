...
QBCore.Commands.Add("resetparachute", "Ranger son parachute", {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Commands.Add("resetarmor", "Réinitialiser le gilet par balle (Police uniquement)", {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player.PlayerData.job.name == "police" then
        TriggerClientEvent("consumables:client:ResetArmor", source)
    else
        TriggerClientEvent('QBCore:Notify', source,  "Pour les services d'urgence seulement", "error")
    end
end)