...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Où voudriez-vous commencer?"><p><span id="null">Où voudriez-vous commencer?</span></p></div>')
    
    setTimeout(function(){
        $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Dernier emplacement"><p><span id="current-location">Dernier emplacement</span></p></div>');
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Choisissez un appartement"><p><span id="null">Choisissez un appartement</span></p></div>')
