...
repairCfg = {
	...
	fixMessages = {
        "Vous avez vérifié le niveau d'huile",
        "Vous avez fermé le déversement d'huile avec un chewing-gum",
        "Vous avez réparé le tuyau d'huile avec du ruban adhésif",
        "Vous avez temporairement arrêté la fuite d'huile",
        "Vous avez frappé le vélo et ça marche à nouveau",
        "Vous avez retiré la rouille",
        "Vous avez crié sur votre voiture et ça marche à nouveau"
    },
    fixMessageCount = 7,

    noFixMessages = {
        "Vous avez regardé votre niveau d'huile et cela avait l'air normal",
        "Vous avez regardé votre vélo et tout semble correct",
        "Vous avez regardé le ruban adhésif sur votre tuyau d'huile et sa vous semble bien",
        "Vous avez monté la radio. Le bruit étrange du moteur a maintenant disparu",
        "Le dérouillant que vous avez utilisé n'a eu aucun effet",
        "N'essaye jamais de faire quelque chose qui n'est pas cassé, mais tu n'as pas écouté"
    },
	noFixMessageCount = 6
}
