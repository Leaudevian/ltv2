...
if Config.Debug then
 ...
 --- atm qb-target models and event trigger
...
exports['qb-target']:AddTargetModel(atm, {
    options = {
        {
            event = "qb-atms:client:qb-target:atm",
            icon = "fas fa-wallet",
            label = "atm",
        },
    },
...
--- models and event trigger for qb-quest (criminal side)

local pnj_quest_1 = {
    1809430156,
}

exports['qb-target']:AddTargetModel(pnj_quest_1, {
    options = {
        {
            event = "tbd",
            icon = "fas fa-wallet",
            label = "donnez 5x coke et 5x meth",
        },
    },
    distance = 2
})

-- qb-quest pnj 2 pour les crimis

local pnj_quest_2 = {
    -2039072303,
}

exports['qb-target']:AddTargetModel(pnj_quest_2, {
    options = {
        {
            event = "tbd",
            icon = "fas fa-wallet",
            label = "donnez 100.000$",
        },
    },
    distance = 2
})
...
RegisterNetEvent('call_anonymous')
AddEventHandler('call_anonymous', function(data)
    TriggerEvent("tbd", data)
end)
...
exports['qb-target']:AddTargetModel(payphone, {
    options = {
        {
            event = "call_anonymous",
            icon = "fas fa-phone",
