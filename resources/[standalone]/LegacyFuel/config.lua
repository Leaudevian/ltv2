...
Config.Strings = {
	...
	EToRefuel = "Appuyer sur ~g~E ~w~ pour faire le plein",
	JerryCanEmpty = "Le Jerrycan est vide",
	FullTank = "Le réservoire est plein",
	PurchaseJerryCan = "Appuyer sur ~g~E ~w~ pour acheter un Jerrycan pour ~g~" .. Config.JerryCanCost.. "$",
	CancelFuelingPump = "Appuyer sur ~g~E ~w~ pour arrêté la pompe",
	CancelFuelingJerryCan = "Appuyer sur ~g~E ~w~ pour arrêté la pompe",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyer sur ~g~E ~w~ pour remplir le Jerrycan",
	NotEnoughCashJerryCan = "Pas assez d'argent pour remplir Jerrycan",
	JerryCanFull = "Le Jerrycan est plein",
	TotalCost = "Coût",
	PurchaseJerryCan = "Appuyer sur ~g~E ~w~ pour prendre le Jerrycan",
	RefillJerryCan = "Appuyer sur ~g~E ~w~ déposer le Jerrycan",
}
