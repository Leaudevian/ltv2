	...
	Citizen.CreateThread(function()
		while true do
			if displayHud then
				...
				DrawAdvancedText(0.2195 - x, 0.77 - y, 0.005, 0.0028, 0.6, carburant, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.148 - x, 0.7765 - y, 0.005, 0.0028, 0.4, "mp/h              km/h              Carburant", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
